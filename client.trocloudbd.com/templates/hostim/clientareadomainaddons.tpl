        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?action=domainaddons">
            ...
            {if $action eq "buy"}
                ...
                {if $addon eq "dnsmanagement"}
                    ...
                    {include file="$template/includes/alert.tpl" type="info" msg="Domain: <strong>{$domain}</strong>" textcenter=false}
            ...
            {elseif $action eq "disable"}
                ...
                {if $success}
                    {include file="$template/includes/alert.tpl" type="success" msg="{lang key='domainaddonscancelsuccess'}" textcenter=false}
                {elseif $error}
                    {include file="$template/includes/alert.tpl" type="error" msg="{lang key='domainaddonscancelfailed'}" textcenter=false}
                {else}
                    <p class="text-center">
...
<a href="clientarea.php?action=domaindetails&id={$domainid}" class="btn btn-default btn-sm">
