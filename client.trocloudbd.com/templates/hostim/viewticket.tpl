...
{if !$invalidTicketId}
    <div class="card view-ticket mb-4">
        <div class="card-body p-3 bg-primary-light">
            <h3 class="h6">
            ...
            <p class="mb-0">
                <strong>{lang key='supportticketssubject'} :</strong>
                {$subject}
            </p>
        </div>
    ...
    <div class="card d-print-none bg-gray-light tt-custom-card" id="ticketReplyContainer">
        <div class="card-body">
            <form method="post" action="{$smarty.server.PHP_SELF}?tid={$tid}&amp;c={$c}&amp;postreply=true" enctype="multipart/form-data" role="form" id="frmReply">
                ...
                <div class="form-group">
                    <input class="btn btn-primary mr-2" type="submit" name="save" value="{lang key='supportticketsticketsubmit'}" />
