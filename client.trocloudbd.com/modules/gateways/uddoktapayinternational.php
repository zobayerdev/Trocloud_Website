...
function uddoktapayinternational_config()
{
    return [
        'FriendlyName' => [
            'Type' => 'System',
...
function uddoktapayinternational_errormessage()
{
    $errorMessage = [
